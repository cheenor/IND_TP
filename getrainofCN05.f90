...
call output(raw,yy,mm,dd,ndd,rgns)
  ...
  pathout='/Volumes/MacHD/Work/Papers/WK03-2/DATA/'
!-----------ETP--------------------------------------------------
  lons(1)=90;lone(1)=100
  lats(1)=27.5;late(1)=35
!-----------WTP--------------------------------------------------
  lons(2)=80;lone(2)=90
  lats(2)=27.5;late(2)=35
!-----------PRD--------------------------------------------------
